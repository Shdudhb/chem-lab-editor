import { getEquipmentSnapPointProfile } from '../equipment/equipment-geometry.js';
...
export const getSnapPoints = (object) => {
  const profile = Array.isArray(object.snapPoints)
    ? object.snapPoints
    : getEquipmentSnapPointProfile(object.sourceId);
  if (profile !== undefined) return profile.map(([x, y, role]) => edgePoint(object, x, y, role));
  return [
